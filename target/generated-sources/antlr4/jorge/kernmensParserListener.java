...
public interface kernmensParserListener extends ParseTreeListener {
	 ...
	 * @param ctx the parse tree
	 */
	void enterDoubleBarline(kernmensParser.DoubleBarlineContext ctx);
	/**
	 * Exit a parse tree produced by {@link kernmensParser#doubleBarline}.
	 * @param ctx the parse tree
	 */
	...
	/**
	 * Enter a parse tree produced by {@link kernmensParser#noteName}.
	 * @param ctx the parse tree
	 */
	void enterNoteName(kernmensParser.NoteNameContext ctx);
	/**
	 * Exit a parse tree produced by {@link kernmensParser#noteName}.
	 * @param ctx the parse tree
	 */
	void exitNoteName(kernmensParser.NoteNameContext ctx);
	/**
	 * Enter a parse tree produced by {@link kernmensParser#noteNameCl}.
	 * @param ctx the parse tree
	 */
	void enterNoteNameCl(kernmensParser.NoteNameClContext ctx);
	/**
	 * Exit a parse tree produced by {@link kernmensParser#noteNameCl}.
	 * @param ctx the parse tree
	 */
