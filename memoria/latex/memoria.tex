...
como es el caso de IMSLP \todo[inline]{Añadir enlace}. Además, las bibliotecas públicas y privadas realizan muchos esfuerzos para publicar sus coleciones
...
\subsection{Kern y Mens}
 Actualmente hay varios sistemas de representación musical como puede ser DARMS, SCORE, EsAC, Kern\todo{Referencias a todos}. Estos sistemas
...
Humdrum\todo{Introduce qué es antes - para qué vale - y pon una referencia} ha diseñado una representación secuencial musical de manera vertical
...
soporta notaciones trandicional del Oeste\todo[inline]{no sé si has usado un traductor, pero suena muy raro - es notación moderna occidental - puedes ponerlo también en inglés},
también denominada notación moderna y en ella podemos manipular:

    El tono: accidentes\todo{alteraciones}, claves, posición de claves, armadura, formula de compás...
...
Una variante de la representación de Kern es Mens\todo{Se escribe **kern y **mens - añade referencias}. Este tipo de representación acoje todo tipo de notación mensural blanca
...
Para implementar nuestro analizador usaremos una herramienta denominada ANTLR4\todo{referencia al libro}. Con esta herramienta podemos contruir reconocedores
